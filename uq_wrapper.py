...
def load_base_config(config_path: str = "cfgs/geballe_no_diamond.yaml") -> Dict[str, Any]:
    """
...
def create_config_from_sample(sample: np.ndarray, 
                             ...
                             config_path: str = "cfgs/geballe_no_diamond.yaml") -> Dict[str, Any]:
    """
...
def run_single_simulation(sample: np.ndarray, 
                         ...
                         base_config: Optional[Dict[str, Any]] = None,
                         config_path: str = "cfgs/geballe_no_diamond.yaml",
