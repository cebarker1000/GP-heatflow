...
class SurrogateEvaluator:
    ...
    def evaluate_on_training_data(self):
        ...
        surrogate_curves, surrogate_fpca_scores, surrogate_uncertainties = \
    ...
    def _compute_parameter_sensitivity(self):
        ...
        base_predictions, _, _ = self.surrogate.predict_temperature_curves(base_parameters)
        ...
        for i, param_name in enumerate(self.surrogate.parameter_names):
            ...
            perturbed_predictions, _, _ = self.surrogate.predict_temperature_curves(perturbed_parameters)
    ...
    def create_visualization_plots(self, results, output_dir="outputs"):
        """
